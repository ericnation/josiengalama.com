...
/**
 * [vinero_add_custom_choice]
 * @param array $default_variants [Default variants for this Typography fields.]
 */

function vinero_add_custom_choice( $custom_choice = array() ) {
	...
	$choices = array(
		'fonts' => array(
			...
			'families' => array(
				'custom' => array(
					'text' => esc_html__( 'Typekit Fonts', 'vinero' ),
					'children' => $children,
				),
			),
			'variants' => $variants,
	...
	return apply_filters( 'vinero/add_custom_choice', $choices );
