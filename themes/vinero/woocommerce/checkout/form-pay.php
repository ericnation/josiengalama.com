...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'vinero' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'vinero' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'vinero' ); ?></th>
			</tr>
		</thead>
		<tbody>
	...
	<div id="payment">
		...
		<div class="form-row">
			...
			<?php echo apply_filters( 'woocommerce_pay_order_button_html', '<input type="submit" class="vlt-btn vlt-btn--primary block" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' ); ?>
