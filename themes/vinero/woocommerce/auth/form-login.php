...
<?php wc_print_notices(); ?>
	...
	<p><?php printf( __( 'To connect to %1$s you need to be logged in. Log in to your store below, or <a href="%2$s">cancel and return to %1$s</a>', 'vinero' ), wc_clean( $app_name ), esc_url( $return_url ) ); ?></p>
...
<form method="post" class="wc-auth-login">
	...
	<p class="wc-auth-actions">
		...
		<input type="submit" class="vlt-btn vlt-btn--primary" name="login" value="<?php esc_attr_e( 'Login', 'vinero' ); ?>" />
